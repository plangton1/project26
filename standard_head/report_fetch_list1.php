...
if(($_POST['query']) != '')
{
 ...
 c.standard_idtb,g.standard_idtb,g.fileupload AS name_file , h.group_id,i.group_id,i.group_name AS name_group
 ...
 INNER JOIN dimension_group h ON c.standard_idtb  = h.standard_idtb
 INNER JOIN group_tb i ON i.group_id = h.group_id    WHERE c.standard_idtb IN ($search_text) ";
}
else
{
 $query = "";
