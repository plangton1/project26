...
if(($_POST['query']) != '')
{
 ...
 standard_detail as standard_detail1 ,  ff.type_name as name_type1 , ee.group_name as name_group1 , dd.department_name as name_depart1 , a.standard_day as standard_day1 , a.standard_number as standard_number1 ,
 a.standard_idtb,
 COUNT(*) as num_id,
 ...
 FROM main_std a
   ...
   left JOIN type_tb ff ON f.type_id = ff.type_id
    ...
    WHERE a.standard_idtb IN ($search_text) GROUP BY  a.standard_idtb , b.statuss_name ,
     j.source_name , a.standard_detail  , ff.type_name , ee.group_name  , dd.department_name  , a.standard_day , a.standard_number    ";
}
else
{
 $query = "";
...
while($row = sqlsrv_fetch_array($statement, SQLSRV_FETCH_ASSOC)){
  ...
  if ($_POST['standard_day1'] == 'true') {
    $output .= '<td>'.$row["standard_day1"].'</td>';
  }
